...
pyboard_button = Digital_input('X17', rising_event='button_release', # USR button on pyboard.
                                     falling_event='button_press', pull='up')

analog_input = Analog_input('X1', 'Analog', 1000, threshold=2000, 
